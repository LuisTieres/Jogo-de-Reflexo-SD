...
ARCHITECTURE structure OF mcu_project IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
\ALU0|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ALU0|Mux3~0_combout\ = (\SW[1]~input_o\ & !\SW[2]~input_o\)
...
\ALU0|Mux3~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ALU0|Mux3~1_combout\ = (\ALU0|Mux3~0_combout\ & ((\SW[6]~input_o\ & ((\SW[0]~input_o\) # (\SW[3]~input_o\))) # (!\SW[6]~input_o\ & (\SW[0]~input_o\ & \SW[3]~input_o\))))
...
-- Equation(s):
-- \ALU0|Mux2~0_combout\ = (\ALU0|Mux3~0_combout\ & ((\SW[4]~input_o\ & ((\SW[0]~input_o\) # (\SW[7]~input_o\))) # (!\SW[4]~input_o\ & (\SW[0]~input_o\ & \SW[7]~input_o\))))
...
\ALU0|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \ALU0|Mux1~0_combout\ = (\ALU0|Mux3~0_combout\ & ((\SW[0]~input_o\ & ((\SW[5]~input_o\) # (\SW[8]~input_o\))) # (!\SW[0]~input_o\ & (\SW[5]~input_o\ & \SW[8]~input_o\))))
